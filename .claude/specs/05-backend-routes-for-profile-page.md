...
- **Modify**: `templates/profile.html`
  - Amounts must be rendered with the Rs symbol (Indian Rupee).
...
- [ ] Total spent displayed on the profile page equals Rs346.24
...
- [ ] Registering a brand-new user and visiting `/profile` shows Rs0.00 total spent, 0 transactions, and an empty category breakdown — no errors